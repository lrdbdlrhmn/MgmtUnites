...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Prémiere",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précedent"},sEmptyTable:"No data available in table",sInfo:"Affichage _START_ to _END_ of _TOTAL_ entrées",sInfoEmpty:"Affichage 0 to 0 of 0 entrées",
sInfoFiltered:"(filtré de _MAX_ total entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affichage _MENU_ entrées",sLoadingRecords:"Rechargement...",sProcessing:"Processus...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Votre recherche n'a donné aucun résultat"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
